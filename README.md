...
3) `config/db.php` içindeki DB bilgilerini ayarlayın.
4) Tarayıcıda `http://localhost/index.php` açın. Admin: `http://localhost/admin/index.php` (kullanıcı: admin / admin123).
